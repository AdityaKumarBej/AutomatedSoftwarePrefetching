...
clang -O3 cg.c -S -emit-llvm  -Xclang -load -Xclang ../../package/plugin-llvm-sw-prefetch-pass/SwPrefetchPass.so
clang -O3 cg.ll -c
...
#clang -O3 cg.c -S -emit-llvm  -Xclang -load -Xclang ../../package/plugin-llvm-sw-prefetch-no-strides-pass/lib/SwPrefetchPass_noStrides.so
clang -O3 cg.ll -c
...
clang -O3 cgswpf.c -c -DFETCHDIST=64 -DSTRIDE
...
# do
#   clang -O3 cgswpf.c -c -DFETCHDIST=$i -DSTRIDE
...
# done
#   clang -O3 cgswpf.c  -c -DFETCHDIST=64
