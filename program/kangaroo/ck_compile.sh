...
CK_NAS_COMMON='.'
CK_ENV_PLUGIN_LLVM_SW_PREFETCH_PASS_FILE='../../package/plugin-llvm-sw-prefetch-pass/SwPrefetchPass.so'
CK_COMPILER="clang"
CK_COMPILE_TYPE="offset"
CK_KANGAROO_ARRAYS=10
CK_KANGAROO_HASHES=5
CK_KANGAROO_SIZE=2
echo ""
...
if [ "${CK_COMPILE_TYPE}" == "auto" ] ; then
  ...
  EXECUTE3="$CK_COMPILER -fPIC kangaroo.o c_print_results.c c_timers.c wtime.c -lm"
  ...
  echo "*** man (64) ***"
  EXECUTE1="$CK_COMPILER -fPIC ./kangaroo.c -DNARRAYS=${CK_KANGAROO_ARRAYS} -DNHASH=${CK_KANGAROO_HASHES} -DKANG_SIZE=${CK_KANGAROO_SIZE} -DNSWPF=${CK_KANGAROO_NUMPFS} -DFETCHDIST=64 -DSTRIDE -DNSWPF=0 -c"
  EXECUTE2=""
  EXECUTE3="$CK_COMPILER -fPIC kangaroo.o c_print_results.c c_timers.c wtime.c -lm"
